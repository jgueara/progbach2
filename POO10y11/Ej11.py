...
class Aplicacion:
    def __init__(self):
        self.ventana1=tk.Tk()
        self.labelframe1=ttk.LabelFrame(self.ventana1, text="Ecuación Segundo grado")
    ...
    def agregar_componentes(self):
        self.label1=ttk.Label(self.labelframe1, text="Ingrese el valor de a:")
    ...
    def calcular(self):
        if self.dato1.get()=="" or self.dato2.get()=="" or self.dato3.get()=="":
            ...
            if contenidoRaiz<0:
                ...
                x1=(-b+raiz)/2*a
                x2=(-b-raiz)/2*a
                solucion="x1="+str(x1)+" x2="+str(x2)
                mb.showinfo("Solución", solucion)
